...
namespace Cyan {
	...
	public class BlitEditor : PropertyDrawer {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			...
			// AfterRenderingPostProcessing event now works correctly in 2021
			...
			EditorGUILayout.PropertyField(property.FindPropertyRelative("overrideViewProjection"));
			...
			EditorGUILayout.LabelField("Source (passed into global texture _MainTex)", boldLabel);
